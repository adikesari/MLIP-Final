...
Code Reference: https://github.com/megvii-research/NAFNet
'''
import torch
...
def build_network(local=False, **kwargs):
    if local:
...
class NAFNetLocal(Local_Base, NAFNet):
    def __init__(self, train_size=(1, 3, 224, 224), fast_imp=False, **kwargs):
        Local_Base.__init__(self)
        NAFNet.__init__(self, **kwargs)
